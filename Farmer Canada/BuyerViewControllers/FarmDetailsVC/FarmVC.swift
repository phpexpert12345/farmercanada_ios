...
class FarmVC: BaseVC, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    @IBOutlet weak var imageViewFollowing: UIImageView!
    @IBOutlet weak var imageViewAddFollow: UIImageView!
    @IBOutlet weak var viewFollowingBg: UIView!
...
//            });
    ...
    func setupViewDidLoadMethod() -> Void {
        ...
        self.imageViewFollowing.layer.cornerRadius = self.imageViewFollowing.bounds.height/2
        self.imageViewFollowing.layer.masksToBounds = true
        UtilityMethods.changeImageColor(self.imageViewAddFollow, .white)
        self.viewFollowingBg.layer.cornerRadius = self.viewFollowingBg.bounds.height/2
        self.viewFollowingBg.backgroundColor = Colors.colorWithHexString(Colors.APP_COLOR)
...
//    MARK:- Button Action
    ...
    @IBAction func btnChatTapped(_ sender: UIButton) {
        let chatVC = ChatVC.init(nibName: "ChatVC", bundle: nil)
        self.navigationController?.pushViewController(chatVC, animated: true)
    }
    
    @IBAction func btnFollowTheFarmTapped(_ sender: UIButton) {
